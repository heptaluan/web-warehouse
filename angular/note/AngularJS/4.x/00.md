...
│   ├── app                                 组件所在文件夹
│   │    │
│   │    ├── src/app/app.component.css      组件的样式文件
│   │    │
│   │    ├── src/app/app.component.html     组件的 HTML 模板文件
│   │    │
│   │    ├── src/app/app.component.spec.ts  组件的单元测试文件
│   │    │
│   │    ├── src/app/app.component.ts       组件定义文件
│   │    │
│   │    └── src/app/app.module.ts          模块定义配置文件
│   │
│   ├── assets                              静态资源
│   │    │
